# Hiraclaw Quick Start for macOS and Linux
...
```bash
npm install -g @gitlawb/hiraclaw@latest
```

## 7. Uninstalling Hiraclaw

```bash
npm uninstall -g @gitlawb/hiraclaw
```
