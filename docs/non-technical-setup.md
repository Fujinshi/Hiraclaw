# Hiraclaw for Non-Technical Users
...
Hiraclaw lets you use an AI coding assistant with different model providers such as:
...
After you run `hiraclaw`, the CLI should start and wait for your prompt.
