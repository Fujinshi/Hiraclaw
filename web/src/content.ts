export const installCommand = 'npm install -g @gitlawb/hiraclaw'
...
export const features = [
  ...
  },
  {
    ...
    body: 'save model, base url, auth, and runtime defaults to .hiraclaw-profile.json so every clone boots the same way.',
  },
  {
...
export const navLinks = [
  ...
  { href: 'https://github.com/Gitlawb/hiraclaw', label: 'github' },
  { href: 'https://gitlawb.com/node/repos/z6MkqDnb/hiraclaw', label: 'gitlawb' },
] as const
