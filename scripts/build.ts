/**
 * Hiraclaw build script — bundles the TypeScript source into a single
...
result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.ISSUES_EXPLAINER':
      JSON.stringify('report the issue at https://github.com/Gitlawb/hiraclaw/issues'),
    'MACRO.FEEDBACK_CHANNEL':
      JSON.stringify('https://github.com/Gitlawb/hiraclaw/issues'),
    'MACRO.PACKAGE_URL': JSON.stringify('@gitlawb/hiraclaw'),
...
if (!result.success) {
  ...
  console.log(`✓ Built hiraclaw v${version} → dist/cli.mjs`)
}
