...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/hiraclaw.proto')
...
const hiraclawProto = protoDescriptor.hiraclaw.v1
...
async function main() {
  ...
  const client = new hiraclawProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mHiraclaw gRPC CLI\x1b[0m')
