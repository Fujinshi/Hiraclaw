...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Hiraclaw now.</p>
    <p>Hiraclaw will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Hiraclaw.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Hiraclaw.</p>
  </body>
</html>`
}
