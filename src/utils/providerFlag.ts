 ...
 *
 * Usage:
 *   hiraclaw --provider openai --model gpt-4o
 *   hiraclaw --provider gemini --model gemini-2.0-flash
 *   hiraclaw --provider mistral --model ministral-3b-latest
 *   hiraclaw --provider ollama --model llama3.2
 *   hiraclaw --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `hiraclaw --model <name>` should work standalone so users can
