...
function getLaunchConfig() {
  const cfg = vscode.workspace.getConfiguration('hiraclaw');
  const command = cfg.get('launchCommand', 'hiraclaw');
...
class HiraclawChatViewProvider {
...
class HiraclawChatPanelManager {
  constructor(chatController) {
    this._chatController = chatController;
    this._panel = null;
  }
