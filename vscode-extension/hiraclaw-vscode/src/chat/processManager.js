/**
 * ProcessManager — spawns Hiraclaw in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The hiraclaw binary (e.g. 'hiraclaw')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'hiraclaw';
